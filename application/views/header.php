...
<html>
<head>
    <title>Aplikasi Music Online</title>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-examplenavbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li><a href="<?php echo base_url().'admin/alatmusik'; ?>"><span class="glyphicon glyphicon-folder-open"></span>Daftar alat musik</a></li>
            ...
            <li class="dropdown"><a href="<?php echo base_url().'#'; ?>" class="dropdown-toggle"
              ...
              <ul class="dropdown-menu">
                <li><a href="<?php echo base_url().'admin/cetak_laporan_alatmusik' ?>">
              <i class="glyphicon glyphicon-lock"></i>Laporan Daftar alat musik</a></li>
